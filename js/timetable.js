    ...
    if (swap && swap.type === 'makeup') {
      return `<div class="daily-row daily-makeup clickable" data-period="${period}">
        ...
        <div class="daily-content">
          <div class="daily-before">${base ? escapeHtml(base.subject) + ' · ' + escapeHtml(base.teacher) : '(빈 교시)'}</div>
          <div class="daily-badge">📘 ${escapeHtml(formatShortDate(swap.sourceDate))} 결강 보강</div>
